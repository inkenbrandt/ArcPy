#--------------------------------------------------------------
# Purpose:     Creates a quarter quarter section grid from an
...
arcpy.SetProgressor("step", "Creating QQ Sections...", 0, count, 1)
...
for row in search_cursor:
    try:
        ...
        qq(top_left_X, top_right_X, top_left_Y, top_right_Y, bottom_left_X, bottom_right_X, bottom_left_Y, bottom_right_Y, int(4))
